...
//var_dump( $job );
//$job = ( beanstalk_peek( $b, 6));
//$job = beanstalk_reserve( $b );
//var_dump( $job );
//var_dump( beanstalk_peekReady( $b ));
//var_dump( beanstalk_peek( $b, 2 ));
//$job = beanstalk_reserve( $b );
//var_dump( $job );
//$job = beanstalk_reserve( $b );
//var_dump( $job );
...
var_dump( beanstalk_peekReady( $b ));
//var_dump( beanstalk_peek( $b, 2 ));
//var_dump( beanstalk_peek( $b, 3 ));
//var_dump( beanstalk_peek( $b, 4 ));
//var_dump( beanstalk_peek( $b, 5 ));
$job = beanstalk_reserve( $b );
var_dump( $job );
$job = beanstalk_reserve( $b );
var_dump( $job );
